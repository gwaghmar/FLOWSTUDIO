...
export const TEMPLATES: Template[] = [
  ...
  {
    id: "cloud-aws-webapp",
    title: "AWS Web App Architecture",
    description: "A production 3-tier AWS layout: CloudFront and a load balancer in front of ECS services, with RDS, ElastiCache, and S3 behind them.",
    diagramType: "cloud",
    themeId: "stage_pipeline",
    tag: "Engineering",
    category: "architecture",
    ...
    source: JSON.stringify({
      nodes: [
        { id: "cf", position: { x: 0, y: 120 }, data: { label: "CloudFront", provider: "aws", service: "cdn" } },
        { id: "alb", position: { x: 240, y: 120 }, data: { label: "App Load Balancer", provider: "aws", service: "load-balancer" } },
        { id: "api", position: { x: 480, y: 30 }, data: { label: "ECS: API", provider: "aws", service: "container" } },
        { id: "auth", position: { x: 480, y: 210 }, data: { label: "ECS: Auth", provider: "aws", service: "container" } },
        { id: "rds", position: { x: 740, y: 30 }, data: { label: "RDS Postgres", provider: "aws", service: "database" } },
        { id: "cache", position: { x: 740, y: 150 }, data: { label: "ElastiCache", provider: "aws", service: "cache" } },
        { id: "s3", position: { x: 240, y: 280 }, data: { label: "S3 Assets", provider: "aws", service: "object-storage" } },
      ],
      edges: [
        { id: "e1", source: "cf", target: "alb" },
        { id: "e2", source: "cf", target: "s3", label: "static" },
        { id: "e3", source: "alb", target: "api" },
        { id: "e4", source: "alb", target: "auth" },
        { id: "e5", source: "api", target: "rds", label: "r/w" },
        { id: "e6", source: "api", target: "cache" },
        { id: "e7", source: "auth", target: "rds" },
      ],
    }, null, 2),
  },
  {
    ...
    description: "A reporting hierarchy for an early-stage startup — CEO over CTO, CFO, and VP Sales, with engineering directors underneath.",
    ...
    source: JSON.stringify({
      nodes: [
        ...
        { id: "d1", position: { x: 20, y: 260 }, data: { label: "Raj Patel", title: "Director, Platform" } },
        { id: "d2", position: { x: 220, y: 260 }, data: { label: "Sara Kim", title: "Director, Product Eng" } },
        { id: "ae", position: { x: 540, y: 260 }, data: { label: "Alex Rivera", title: "Account Executive" } },
      ],
      edges: [
